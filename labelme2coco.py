...
class labelme2coco(object):
    def __init__(self,labelme_json=[],save_json_path='/home/lenovo/Dataset/val/new.json'):
        '''
    ...
    def save_json(self):
        ...
        # 保存json文件
        print("where",self.save_json_path)
...
# labelme_json=['./1.json']
labelme_json=file_name("/home/lenovo/Dataset/val")
# print(labelme_json)
labelme2coco(labelme_json,'/home/lenovo/Dataset/val/new.json')
print("ok")
